...
const ZovuStore = () => {
  ...
  // Expanded catalog with categories in English
  const products = [
    ...
    { id: 7, name: 'Vintage Denim Jacket', price: 120.00, category: 'Men', img: 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&w=500&q=80' },
    { id: 8, name: 'Retro Sunglasses', price: 55.00, category: 'Accessories', img: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=500&q=80' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      {/* HERO BANNER (Only shown on 'New Arrivals') */}
      ...
      <main className="max-w-7xl mx-auto px-4 py-16 min-h-[60vh]">
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20 text-gray-500">
            <p className="text-xl">No products available in this category right now.</p>
          </div>
        ) : (
